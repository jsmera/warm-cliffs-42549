...
urlpatterns = [
    ...
    url(
        r"^pacientes/lista-pacientes/$",
        PacienteListView.as_view(),
        name="lista-pacientes",
    ),
    url(
        r"^pacientes/crear-pacientes/$",
        CreatePacienteView.as_view(),
        name="crear-pacientes",
    ),
    url(
        r"^pacientes/(?P<uuid>[-\w]+)/editar-pacientes/$",
        UpdatePacienteView.as_view(),
        name="editar-pacientes",
    ),
    url(
        r"^pacientes/(?P<uuid>[-\w]+)/eliminar-pacientes/$",
        DeletePacienteView.as_view(),
